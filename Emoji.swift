...
struct Emoji: Codable {
    ...
    static func loadFromFile() -> [Emoji] {
        ...
        if let retrievedEmojiData = try? Data(contentsOf: Emoji.archiveURL), let decodedEmoji = try? propertyListDecoder.decode(Array<Emoji>.self, from: retrievedEmojiData) {
